import { activeProfile, useProfiles } from '../profiles';
  ...
  return (
    <View style={styles.section}>
      <Text style={styles.title}>
        {student ? `${student.name}’s activity` : 'Guest activity on this device'}
      </Text>
      ...
      {failed ? (
        <Text style={styles.note}>Counters unavailable. Reopen Settings to retry.</Text>
      ) : (
        summary && (
          <Text style={styles.note}>
            Tracking since {new Date(summary.since).toLocaleString()}.{'\n'}Updated{' '}

...
for i,pack in enumerate(m['packs']):
 ...
 s.put_object(Bucket='hiraia-assets',Key=key,Body=data,ContentType='application/octet-stream',CacheControl='public, max-age=31536000, immutable',Metadata={'sha256':pack['sha256'],'md5':pack['md5']})

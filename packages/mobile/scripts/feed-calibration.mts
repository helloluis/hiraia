...
import { cardWeight, weightedPick, curriculumMultiplier } from '/Users/luis/Code/hiraia/packages/shared/src/curriculum/feedWeighting.ts';
const raw = JSON.parse(fs.readFileSync('/Users/luis/Code/hiraia/packages/mobile/src/generated/curriculumTags.generated.json','utf8'));
const pool = JSON.parse(fs.readFileSync('/Users/luis/Code/hiraia/packages/mobile/src/generated/cardsPool.generated.json','utf8')).cards as {id:string}[];

...
for (const f of files) { const s = basename(f, '.png'); if (!slugPath.has(s)) slugPath.set(s, f); }
...
// ${mapEntries.length} bundled 512x512 science images. Metro packages each require().
/* eslint-disable */

                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 text-gray-600 space-y-1.5 text-sm sm:text-base leading-relaxed">
                    ...
                    <li>
                      ...
                      <strong className="text-[#0c343d]">student evaluation and sync</strong>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-4 sm:gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm sm:text-base leading-relaxed pl-1">
                    Can use FB Messenger for higher-quality cloud-based replies and{' '}
                    <strong className="text-[#0c343d]">fine-tuned image generation</strong>
                  </p>
                </div>
              </div>

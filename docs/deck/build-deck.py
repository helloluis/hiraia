...
text(s, 0.9, 4.0, 9.2, 1.2, "An offline, on-device science tutor for Filipino grade-school students (Grades 3–10), aligned to the DepEd MATATAG curriculum, in Tagalog, Cebuano and English. The published build (v0.1) targets Android 12+ phones with 6 GB+ memory; a 1B budget tier runs on a Redmi (Snapdragon 685) in unpublished builds.", F_BODY, 15, INK)

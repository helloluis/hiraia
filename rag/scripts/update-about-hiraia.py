...
NEW = [
 ...
 fact("about-requirements", "what you need to run Hiraia",
   ["kailangan","requirements","android","10","bersyon","storage","download","unang gamit","first run","offline pagkatapos","unsa kinahanglan"],
   "Kailangan ng Hiraia ang isang Android phone na may Android 10 o mas bago. Sa unang pagbukas mo nito, minsan lang nitong dino-download ang AI model; pagkatapos noon, gumagana na ito nang ganap na offline.",
   "Hiraia needs an Android phone running Android 10 or newer. The first time you open it, it downloads the AI model one time; after that, it works fully offline.",
   "Nagkinahanglan ang Hiraia og Android phone nga adunay Android 10 o mas bag-o. Sa unang pag-abli nimo niini, kausa ra niini i-download ang AI model; human niana, molihok na kini nga hingpit nga offline."),

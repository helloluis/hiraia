 ...
 *   safety (safety-rows.json, {seed,assistant})         — ungrounded yes/no: settled safety.
...
// safety (ungrounded)
for (const r of JSON.parse(readFileSync('finetuning/distill/safety-rows.json', 'utf8'))) {

 ...
 *   safety (safety-rows-v3.json, {seed,assistant})         — ungrounded yes/no: settled safety.
...
// safety (ungrounded)
for (const r of JSON.parse(readFileSync('finetuning/distill/safety-rows-v3.json', 'utf8'))) {

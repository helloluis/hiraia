...
/**
 * Train Tagalog LoRA adapter for Hiraia
...
async function trainTagalogAdapter() {
  console.log('🚀 Starting Tagalog LoRA training...\n');
  ...
  try {
    ...
    // Configure training
    const trainDatasetDir = join(__dirname, '../datasets/tagalog/science-chat.jsonl');
    const outputParametersDir = join(__dirname, '../output/tagalog');

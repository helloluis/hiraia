...
DATASET_PATH = "/workspace/train-distill-v1.jsonl"
OUTPUT_DIR = "/workspace/output/distill-sailor-3b-v1"
...
MAX_SEQ_LENGTH = 1024  # question + <think> + answer fit comfortably

#!/usr/bin/env python3
"""
Train Hiraia v8 LoRA for Sailor2-3B (tl/en adapter slot).

v8 = the v6 trainset + a TARGETED safety/myth patch fixing the temp-0.5 negation bug v6 role-play
...
10%-brain myth affirmed). v8 retrains the opener PATTERN on AUP-safe, NON-body yes/no questions:
...
Dataset: finetuning/distill/train-distill-v8.jsonl (~9.8k rows). Same recipe as v4/v5/v6 (r32/a64/3ep).
"""
...
DATASET_PATH = "/workspace/train-distill-v8.jsonl"
OUTPUT_DIR = "/workspace/output/distill-sailor-3b-v8"
...
def main():
    print("🚀 Hiraia v8 LoRA (Sailor2-3B) — chitchat/abstention/refusal under the contracted prompt\n")

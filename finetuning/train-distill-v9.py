#!/usr/bin/env python3
"""
Train Hiraia v9 LoRA for Sailor2-3B (tl/en adapter slot).
...
DATASET_PATH = "/workspace/train-distill-v9.jsonl"
OUTPUT_DIR = "/workspace/output/distill-sailor-3b-v9"
...
def main():
    print("🚀 Hiraia v9 LoRA (Sailor2-3B) — chitchat/abstention/refusal under the contracted prompt\n")

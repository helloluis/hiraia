...
MODEL_NAME = os.environ.get("HIRAIA_BASE", "sail/Sailor2-1B-Chat")
DATASET_PATH = "/workspace/train-distill-v7.jsonl"
OUTPUT_DIR = "/workspace/output/distill-sailor-1b-kitten-v4"
...
def main():
    print("🚀 Hiraia KITTEN LoRA (Sailor2-1B) — chitchat/abstention/refusal under the contracted prompt\n")

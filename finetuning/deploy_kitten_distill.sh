...
DISK_GB=60; POD_NAME="hiraia-kitten-1b"
...
[ -f distill/train-distill-kitten-v2.jsonl ] || { echo "ERR: distill/train-distill-kitten-v2.jsonl missing"; exit 1; }
...
scp $SSH -P "$PORT" distill/train-distill-kitten-v2.jsonl "root@$IP:/workspace/train-distill-v7.jsonl"
...
Download when done (look for "Adapter saved"):
  scp $SSH -P $PORT -r root@$IP:/workspace/output/distill-sailor-1b-kitten/final-adapter adapters/distill-sailor-1b-kitten-v2/

...
| **Model load** | **2,069 ms** |
| Inference calls | 5 |
| Avg TTFT | 241 ms (540 ms cold → ~165 ms warm) |
| Avg decode | 36.8 tok/s |
| Tokens | 371 prompt / 479 completion |

## Per-call metrics

| # | Probe | Prompt tok | Out tok | TTFT (ms) | tok/s | Total (ms) |
|---|-------|-----------:|--------:|----------:|------:|-----------:|
| 1 | tl-photosynthesis (cold) | 73 | 164 | 540 | 36.85 | 4963 |
| 2 | tl-water-cycle | 76 | 131 | 168 | 36.84 | 3697 |
| 3 | tl-why-sky-blue | 75 | 69 | 167 | 36.70 | 2020 |
| 4 | en-states-of-matter | 75 | 81 | 172 | 37.09 | 2329 |
| 5 | chitchat-greeting | 72 | 34 | 160 | 36.26 | 1070 |

**Reading the TTFT drop:** the first call pays the cold system-prompt prefill (~540 ms);
